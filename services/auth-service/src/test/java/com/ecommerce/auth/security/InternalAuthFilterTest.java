...
class InternalAuthFilterTest {
    ...
    @Test
    void doFilter_pathPublicoDeLogin_noExigeCredencialInternaYContinua() throws Exception {

        // ARRANGE — /auth/login es público (fuera del scope de este filtro,
        // ver comentario de clase): no debe exigir cabeceras internas
    ...
    @Test
    void doFilter_sinCabecerasInternasSobreEndpointInterno_retorna401YNoInvocaLaCadena() throws Exception {

        // ARRANGE
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/auth/interno/usuarios/x@x.cl");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain chain = new MockFilterChain();
    ...
    void doFilter_timestampExpirado_retorna401CredencialExpirada() throws Exception {
        ...
        request.addHeader("X-Internal-Signature", sign("api-gateway", timestampViejo));
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain chain = new MockFilterChain();
    ...
    @Test
    void doFilter_firmaValidaDeOtroServicioDistintoDeApiGateway_retorna403() throws Exception {

        // ARRANGE — solo api-gateway está en el allowlist de /auth/interno/**
        long timestamp = System.currentTimeMillis();
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/auth/interno/usuarios/x@x.cl");
    ...
    @Test
    void doFilter_firmaValidaDeApiGateway_continuaLaCadena() throws Exception {
