package com.smartlogix.inventario.security;
...
class InternalAuthFilterTest {
    ...
    void doFilter_sinCabecerasInternas_retorna401YNoInvocaLaCadena() throws Exception {
        ...
        // ARRANGE
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/inventario/1/reservar");
    ...
    void doFilter_timestampExpirado_retorna401CredencialExpirada() throws Exception {
        ...
        // ARRANGE
        long timestampViejo = System.currentTimeMillis() - 45_000;
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/inventario/1/reservar");
    ...
    void doFilter_firmaForjada_retorna401FirmaInvalida() throws Exception {
        ...
        request.addHeader("X-Internal-Signature", "f".repeat(64));
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain chain = new MockFilterChain();
    ...
    @Test
    void doFilter_apiGatewayLlamandoReservar_retorna403() throws Exception {

        // ARRANGE — /inventario/{id}/reservar solo acepta ms-pedidos,
        // aunque api-gateway sea un emisor confiable en general
        long timestamp = System.currentTimeMillis();
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/inventario/1/reservar");
    ...
    @Test
    void doFilter_msPedidosLlamandoReservar_continuaLaCadena() throws Exception {
    ...
    @Test
    void doFilter_msPedidosLlamandoListarProductos_retorna403() throws Exception {

        // ARRANGE — ms-pedidos solo está autorizado para reservar/liberar/stock,
        // no para el resto de /inventario/**
        long timestamp = System.currentTimeMillis();
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/inventario");
        request.addHeader("X-Internal-Service", "ms-pedidos");
        request.addHeader("X-Internal-Timestamp", String.valueOf(timestamp));
        request.addHeader("X-Internal-Signature", sign("ms-pedidos", timestamp));
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    @Test
    void doFilter_apiGatewayLlamandoListarProductos_continuaLaCadena() throws Exception {
